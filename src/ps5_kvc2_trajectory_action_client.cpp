...
int main(int argc, char** argv) {
	...
	for (phase=0.0;phase<final_phase;phase+=omega*dt) {
		...
		trajectory_point.velocities[0] = qdot_des; // and all velocities (in the server ps5_kvc2, velocities will get ignored)
		...
		trajectory.points.push_back(trajectory_point);	
                ...
                // also, the dt values can be quite coarse in this ps5_kvc2, for the purpose of illustrating the interpolation capability of the server
